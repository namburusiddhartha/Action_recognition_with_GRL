...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    @abstractmethod
    def forward_train(self, imgs, labels, alpha, **kwargs):
        """Defines the computation performed at every call when training."""

    @abstractmethod
    def forward_test(self, imgs, alpha):
    ...
    def forward(self, imgs, label=None, alpha=0.0, return_loss=True, **kwargs):
        ...
        if return_loss:
            ...
            return self.forward_train(imgs, label, alpha, **kwargs)

        return self.forward_test(imgs ,alpha, **kwargs)
    ...
    def train_step(self, data_batch, optimizer, alpha, **kwargs):
        ...
        losses = self(imgs, label, alpha, return_loss=True, **aux_info)
